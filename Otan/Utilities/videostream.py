...
from Otan import BOT_USERNAME, db_mem
from Otan.Core.PyTgCalls import Queues
from Otan.Core.PyTgCalls.Otan import (join_live_stream, join_video_stream,
                                        stop_stream)
from Otan.Database import (add_active_chat, add_active_video_chat,
                            is_active_chat, music_off, music_on,
                            remove_active_chat)
from Otan.Inline import (audio_markup, audio_markup2, primary_markup,
