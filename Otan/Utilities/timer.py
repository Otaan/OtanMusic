...
from Otan.Database import is_active_chat, is_music_playing
from Otan.Inline import audio_timer_markup_start, timer_markup
            ...
            while user_input_time:
                ...
                if await is_music_playing(
                    ...
                    buttons = timer_markup(
                                    ...
                                    ) if aud == 0 else audio_timer_markup_start(
                                        videoid, user_id, c_t, duration_min
                                    )
                    user_input_time -= 1
