...
from Otan import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Otan import boottime as bot_start_time
from Otan import db, random_assistant
from Otan.Core.PyTgCalls import Otan
from Otan.Database import (add_nonadmin_chat, add_served_chat,
...
from Otan.Decorators.admins import ActualAdminCB
from Otan.Decorators.permission import PermissionCheck
from Otan.Inline import (custommarkup, dashmarkup, setting_markup,
                          setting_markup2, start_pannel, usermarkup, volmarkup)
from Otan.Utilities.assistant import get_assistant_details
from Otan.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await Otan.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"Otan Disk Usage: {diske}%", show_alert=True
        )